...
using namespace std; // Para escrever cout ao invés de
		     // std::cout.
// const: constante nao alterra o valor dos atributos
// Time::getHours: os 2 pontos trabalhar como operação de operador por escopo
// void: permite executar funcoes/metodos sem que retornam algum valor ou que tenham parametros
